			...
			<div className="intro">
				...
				<p className="about">
					...
					<p>
						...
						finding answers to problems no-one really cared about. As an adult,
						with a Bachelors in Social Sciences and a service-driven focus, I
						gleefully find answers to problems that can improve the lives of the
						people using my work.
					</p>

					<p>So, tell me. How can I make your day better?</p>
				</p>
